...
<div className="lg:px-[95px] px-[20px] max-w-390 mx-auto pt-10">
    <motion.h1 className="heading-hero text-white text-[5rem] uppercase" 
       initial={{ y: 50, opacity: 0 }}
  whileInView={{ y: 0, opacity: 1 }}
  viewport={{ once: true, amount: 0.3 }}
  transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
    >Hey! I’m Udeh Precious</motion.h1>

    <motion.p className="tools-des text-[1rem] text-white max-w-[60rem]"
    initial={{ y: 50, opacity: 0 }}
  whileInView={{ y: 0, opacity: 1 }}
  viewport={{ once: true, amount: 0.3 }}
  transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
    >I’m a Webflow Partner building high-performance websites for B2B companies. I help businesses turn complex ideas into clean, responsive, and conversion-focused Webflow sites that scale.</motion.p>
...
initial={{ y: 50, opacity: 0 }}
  ...
  viewport={{ once: true, amount: 0.3 }}
  transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
>Some of the brands I’ve collaborated with include: Raenest, Xio Ai, Stayvera and Bech32, delivering digital experiences that combine design, usability, and results. From landing pages to full corporate platforms, my focus is on creating Webflow solutions that drive business growth.
